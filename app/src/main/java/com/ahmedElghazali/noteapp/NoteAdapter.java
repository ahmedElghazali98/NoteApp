...
import com.ahmedElghazali.noteapp.Note;
import com.ahmedElghazali.noteapp.R;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.BookVh> {
    ...
    class BookVh extends RecyclerView.ViewHolder{
        ...
        public void setData(Note note) {
            ...
            note_date.setText(new SimpleDateFormat("dd/MM/yyyy").format(new Date(note.getCreatedAt())));
